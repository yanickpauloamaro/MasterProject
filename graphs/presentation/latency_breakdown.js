let transfer_0 = [
    ...
    {
      type: 'bar', name: 'Unknown', stack: 'breakdown-transfer-0',
...
let transfer_50 = [
    ...
    {
      type: 'bar', name: 'Unknown', stack: 'breakdown-transfer-50',
...
let hashmap_10 = [
    ...
    {
      type: 'bar', name: 'Unknown', stack: 'breakdown-hashmap-10',
...
let hashmap_50 = [
    {
      // 4 schedulers
      type: 'bar', name: 'scheduling50', stack: 'breakdown-hashmap-50', areaStyle: {},
      data: [ 1605, 1816, 1864, 1928, 1692, 1603, ]
    },
    {
      type: 'bar', name: 'execution50', stack: 'breakdown-hashmap-50', areaStyle: {},
      data: [ 7462, 4003, 2049, 1408, 1442, 1052, ]
    },
    {
      type: 'bar', name: 'Unknown', stack: 'breakdown-hashmap-50',
...
let fib = [
    ...
    {
      type: 'bar', name: 'Unknown', stack: 'breakdown-fib',
