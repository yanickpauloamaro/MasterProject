let point_details = {
  ...
  let series = [
    ...
    { 
      ...
      lineStyle: { width: 3 },
      name: '1 schedulers',
      data: [4.612, 6.792, 9.230, 10.205, 10.684, 10.104],
    },
    { 
      type: 'line', 
      symbolSize: '10',
      lineStyle: { width: 3 },
      name: '2 schedulers',
      data: [5.019, 7.695, 10.491, 11.864, 13.063, 12.815],
    },
    {
      type: 'line', 
      symbolSize: '10',
    ...
    },
    {
      ...
      lineStyle: { width: 3 },
      name: '8 schedulers',
      data: [5.175, 8.085, 11.560, 13.408, 14.067, 13.224],
    },
  ];
  
  option = {
    title: {
      text: 'Hashmap 50% (64 buckets, advanced scheduling)',
